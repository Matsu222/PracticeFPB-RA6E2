...
#define SPI1_MISO (BSP_IO_PORT_01_PIN_00)
#define SPI1_MOSI (BSP_IO_PORT_01_PIN_01)
#define SPI1_SCLK (BSP_IO_PORT_01_PIN_02)
#define SPI1_SS (BSP_IO_PORT_01_PIN_03)
